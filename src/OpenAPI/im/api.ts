 ...
 * 
 * @export
 * @interface AccountCredentialsWebchat
 */
export interface AccountCredentialsWebchat {
    /**
     * 
     * @type {string}
     * @memberof AccountCredentialsWebchat
     */
    'type': AccountCredentialsWebchatTypeEnum;
    /**
     * Public key embedded in the customer\'s website snippet
     * @type {string}
     * @memberof AccountCredentialsWebchat
     */
    'widgetKey': string;
    /**
     * Signs visitor session tokens. Never returned by the API.
     * @type {string}
     * @memberof AccountCredentialsWebchat
     */
    'secret': string;
    /**
     * Incremented on every key rotation. Session tokens carry it, so a rotation invalidates all of them at once.
     * @type {number}
     * @memberof AccountCredentialsWebchat
     */
    'keyVersion'?: number;
...
export const AccountCredentialsWebchatTypeEnum = {
    Webchat: 'webchat'
} as const;

export type AccountCredentialsWebchatTypeEnum = typeof AccountCredentialsWebchatTypeEnum[keyof typeof AccountCredentialsWebchatTypeEnum];
 ...
 * @export
 */
export type AccountsPatchRequestCredentials = AccountCredentialsAlibaba | AccountCredentialsAlibabaV2 | AccountCredentialsMail | AccountCredentialsMeta | AccountCredentialsSms | AccountCredentialsTikTok | AccountCredentialsTikTokShop | AccountCredentialsWebchat;
...
export interface WabaCallPost200Response {
    /**
     * The ID of the initiated call returned by Meta
     * @type {string}
     * @memberof WabaCallPost200Response
     */
    'callId': string;
}
/**
 * 
 * @export
 * @interface WabaCallPostRequest
 */
export interface WabaCallPostRequest {
    /**
     * Phone number of the contact to call (E.164 format, e.g. 15551234567)
     * @type {string}
     * @memberof WabaCallPostRequest
     */
    'chatId': string;
    /**
     * WebRTC SDP offer generated by the browser. Required for media session establishment.
     * @type {string}
     * @memberof WabaCallPostRequest
     */
    'sdp'?: string;
...
export interface WabaDisconnectPost200Response {
     ...
     * @type {boolean}
     * @memberof WabaDisconnectPost200Response
     */
    'success': boolean;
}
/**
 * 
 * @export
 * @interface WabaDisconnectPostRequest
 */
export interface WabaDisconnectPostRequest {
    /**
     * The IM account ID to disconnect
     * @type {string}
     * @memberof WabaDisconnectPostRequest
     */
    'accountId': string;
}
/**
...
export interface WabaIncomingCallClaimPostRequest {
    /**
     * WebRTC SDP generated by the browser. sdpType is \'answer\' if Meta sent an offer in the webhook, \'offer\' if not (browser initiates the offer instead).
     * @type {string}
     * @memberof WabaIncomingCallClaimPostRequest
     */
    'sdp': string;
    /**
     * \'offer\' or \'answer\' depending on which side initiated the SDP negotiation
     * @type {string}
     * @memberof WabaIncomingCallClaimPostRequest
     */
    'sdpType': WabaIncomingCallClaimPostRequestSdpTypeEnum;
}

export const WabaIncomingCallClaimPostRequestSdpTypeEnum = {
    Offer: 'offer',
    Answer: 'answer'
} as const;

export type WabaIncomingCallClaimPostRequestSdpTypeEnum = typeof WabaIncomingCallClaimPostRequestSdpTypeEnum[keyof typeof WabaIncomingCallClaimPostRequestSdpTypeEnum];

/**
 * 
 * @export
 * @interface WabaIncomingCallGet200Response
 */
export interface WabaIncomingCallGet200Response {
    /**
     * 
 ...
 * 
 * @export
 * @interface WabaStatusCheckPost200Response
 */
export interface WabaStatusCheckPost200Response {
    /**
     * Whether the phone number is currently connected on Meta
     * @type {boolean}
     * @memberof WabaStatusCheckPost200Response
     */
    'connected': boolean;
    /**
     * Raw Meta phone number status (CONNECTED, DISCONNECTED, PENDING, etc.)
     * @type {string}
     * @memberof WabaStatusCheckPost200Response
     */
    'status'?: string | null;
 ...
 * 
 * @export
 * @interface WabaStatusCheckPostRequest
 */
export interface WabaStatusCheckPostRequest {
    /**
     * The IM account ID
     * @type {string}
...
/**
 * Everything a visitor\'s browser can send, in one request. Mirrors the shape of a platform webhook so the handler feeds all items into the same messaging pipeline as WhatsApp.
 * @export
 * @interface WebChatEvents
 */
export interface WebChatEvents {
    /**
     * 
     * @type {string}
     * @memberof WebChatEvents
     */
    'sessionToken': string;
    /**
     * New messages from the visitor
     * @type {Array<WebChatEventsMessagesInner>}
     * @memberof WebChatEvents
     */
    'messages'?: Array<WebChatEventsMessagesInner>;
    /**
     * Read receipts for messages the team sent
     * @type {Array<WebChatEventsStatusesInner>}
     * @memberof WebChatEvents
     */
    'statuses'?: Array<WebChatEventsStatusesInner>;
    /**
     * 
     * @type {WebChatVisitorContact}
     * @memberof WebChatEvents
     */
    'contact'?: WebChatVisitorContact;
}
/**
 * 
 * @export
 * @interface WebChatEventsMessagesInner
 */
export interface WebChatEventsMessagesInner {
    /**
     * Id generated by the widget, eg. `wcm_<timestamp>_<random>`. It becomes the stored message id, so retrying with the same id never creates a duplicate.
     * @type {string}
     * @memberof WebChatEventsMessagesInner
     */
    'clientId': string;
    /**
     * 
 ...
 * 
 * @export
 * @interface WebChatEventsStatusesInner
 */
export interface WebChatEventsStatusesInner {
    /**
     * The `Message.id` the widget received
     * @type {string}
     * @memberof WebChatEventsStatusesInner
     */
    'id': string;
    /**
     * 
     ...
     * @memberof WebChatEventsStatusesInner
     */
    'status': WebChatEventsStatusesInnerStatusEnum;
    /**
     * An ISO formatted timestamp
     * @type {string}
     * @memberof WebChatEventsStatusesInner
...
export const WebChatEventsStatusesInnerStatusEnum = {
    Read: 'read'
} as const;

export type WebChatEventsStatusesInnerStatusEnum = typeof WebChatEventsStatusesInnerStatusEnum[keyof typeof WebChatEventsStatusesInnerStatusEnum];

/**
 * Where the visitor is on the customer\'s site
 * @export
 * @interface WebChatPageInfo
 */
export interface WebChatPageInfo {
    /**
     * 
     * @type {string}
     * @memberof WebChatPageInfo
     */
    'url'?: string;
    /**
     * 
...
/**
 * The part of `WebChatSettings` that is safe to hand to the visitor\'s browser. Never includes allowed domains or credentials.
 * @export
...
export interface WebChatPublicConfig {
     ...
     * @memberof WebChatPublicConfig
     */
    'position'?: WebChatPublicConfigPositionEnum;
    /**
     * 
     * @type {string}
     * @memberof WebChatPublicConfig
    ...
    /**
     * 
     * @type {WebChatPublicConfigPreChatForm}
     * @memberof WebChatPublicConfig
     */
    'preChatForm'?: WebChatPublicConfigPreChatForm;
    /**
     * 
     * @type {boolean}
     * @memberof WebChatPublicConfig
...
export const WebChatPublicConfigPositionEnum = {
    Right: 'right',
    Left: 'left'
} as const;

export type WebChatPublicConfigPositionEnum = typeof WebChatPublicConfigPositionEnum[keyof typeof WebChatPublicConfigPositionEnum];

/**
 * 
 * @export
 * @interface WebChatPublicConfigPreChatForm
 */
export interface WebChatPublicConfigPreChatForm {
    /**
     * 
     * @type {boolean}
     * @memberof WebChatPublicConfigPreChatForm
     */
    'enabled'?: boolean;
    /**
     * 
     ...
     * @memberof WebChatPublicConfigPreChatForm
     */
    'fields'?: Array<WebChatPublicConfigPreChatFormFieldsEnum>;
}

export const WebChatPublicConfigPreChatFormFieldsEnum = {
    Name: 'name',
    Phone: 'phone',
    Email: 'email'
} as const;

export type WebChatPublicConfigPreChatFormFieldsEnum = typeof WebChatPublicConfigPreChatFormFieldsEnum[keyof typeof WebChatPublicConfigPreChatFormFieldsEnum];
...
export interface WebChatSession {
    /**
     * Signed token scoped to this one visitor conversation. Sent back in `sessionToken` on every other Web Chat call.
     * @type {string}
     * @memberof WebChatSession
     */
    'sessionToken': string;
    /**
     * Anonymous visitor id minted by the session route and kept in the visitor\'s browser. It doubles as the contact id and the chat id on the Web Chat channel, the way a phone number does on WhatsApp.
     * @type {string}
     * @memberof WebChatSession
     */
    'visitorId': string;
...
/**
 * Configuration of a Web Chat channel: the floating chat box a customer embeds on their own website. Lives under `AccountSettings.webChat`.
 * @export
 * @interface WebChatSettings
 */
export interface WebChatSettings {
    /**
     * Hostnames allowed to load the widget, eg. `shop.example.com` or `*.example.com`. The session route rejects any other origin. An empty list allows every origin and is meant for testing only.
     * @type {Array<string>}
     * @memberof WebChatSettings
     */
    ...
    'bubbleColor'?: string;
    /**
     * Which bottom corner the bubble sits in
     * @type {string}
     * @memberof WebChatSettings
     */
    'position'?: WebChatSettingsPositionEnum;
    /**
     * First message a visitor sees when the panel opens
     * @type {string}
     * @memberof WebChatSettings
     */
    'welcomeMessage'?: string;
    /**
     * 
     * @type {WebChatSettingsAwayReply}
     * @memberof WebChatSettings
     */
    'awayReply'?: WebChatSettingsAwayReply;
    /**
     * 
     * @type {WebChatSettingsPreChatForm}
     * @memberof WebChatSettings
     */
    'preChatForm'?: WebChatSettingsPreChatForm;
    /**
     * Show the \"Powered by ChatDaddy\" line in the widget
     * @type {boolean}
     * @memberof WebChatSettings
     */
    'showPoweredBy'?: boolean;
...
export const WebChatSettingsPositionEnum = {
    Right: 'right',
    Left: 'left'
} as const;

export type WebChatSettingsPositionEnum = typeof WebChatSettingsPositionEnum[keyof typeof WebChatSettingsPositionEnum];

/**
 * Sent automatically when nobody on the team has answered a visitor within `delaySec`
 * @export
 * @interface WebChatSettingsAwayReply
 */
export interface WebChatSettingsAwayReply {
    /**
     * 
     * @type {boolean}
     * @memberof WebChatSettingsAwayReply
     */
    'enabled'?: boolean;
    /**
     * 
...
/**
 * Ask the visitor for their details
 * @export
 * @interface WebChatSettingsPreChatForm
 */
export interface WebChatSettingsPreChatForm {
    /**
     * 
     * @type {boolean}
     * @memberof WebChatSettingsPreChatForm
     */
    'enabled'?: boolean;
    /**
     * Block the first message until the form is filled
     * @type {boolean}
     * @memberof WebChatSettingsPreChatForm
     */
    'required'?: boolean;
     ...
     * @memberof WebChatSettingsPreChatForm
     */
    'fields'?: Array<WebChatSettingsPreChatFormFieldsEnum>;
}

export const WebChatSettingsPreChatFormFieldsEnum = {
    Name: 'name',
    Phone: 'phone',
    Email: 'email'
} as const;

export type WebChatSettingsPreChatFormFieldsEnum = typeof WebChatSettingsPreChatFormFieldsEnum[keyof typeof WebChatSettingsPreChatFormFieldsEnum];

/**
 * Details the visitor has given us, if any
 * @export
 * @interface WebChatVisitorContact
 */
export interface WebChatVisitorContact {
    /**
     * 
     * @type {string}
     * @memberof WebChatVisitorContact
     */
    'name'?: string | null;
    /**
     * E.164 without the plus sign
     * @type {string}
     * @memberof WebChatVisitorContact
     */
    'phoneNumber'?: string | null;
 ...
 * 
 * @export
 * @interface WebchatEventsPost200Response
 */
export interface WebchatEventsPost200Response {
    /**
     * Stored messages, in request order
     * @type {Array<Message>}
     * @memberof WebchatEventsPost200Response
     */
    'messages': Array<Message>;
    /**
     * 
 ...
 * 
 * @export
 * @interface WebchatMessagesGet200Response
 */
export interface WebchatMessagesGet200Response {
    /**
     * Ascending by timestamp
     * @type {Array<Message>}
     * @memberof WebchatMessagesGet200Response
     */
    'messages': Array<Message>;
    /**
     * An agent is typing in this conversation
     * @type {boolean}
     * @memberof WebchatMessagesGet200Response
     */
    'typing'?: boolean;
 ...
 * 
 * @export
 * @interface WebchatRotateKeyPost200Response
 */
export interface WebchatRotateKeyPost200Response {
    /**
     * 
     * @type {string}
     * @memberof WebchatRotateKeyPost200Response
     */
    'widgetKey': string;
}
/**
 * 
 * @export
 * @interface WebchatSessionPostRequest
 */
export interface WebchatSessionPostRequest {
    /**
     * Public key from the site\'s snippet
     * @type {string}
     * @memberof WebchatSessionPostRequest
     */
    'widgetKey': string;
    /**
     * Anonymous visitor id minted by the session route and kept in the visitor\'s browser. It doubles as the contact id and the chat id on the Web Chat channel, the way a phone number does on WhatsApp.
    ...
    'visitorId'?: string;
    /**
     * `window.location.origin` of the page hosting the widget. Checked against the channel\'s allowed domains together with the request\'s Origin header.
     * @type {string}
     * @memberof WebchatSessionPostRequest
     */
    'origin'?: string;
    /**
     * 
     * @type {WebChatPageInfo}
     * @memberof WebchatSessionPostRequest
     */
    'page'?: WebChatPageInfo;
}
/**
 * 
 * @export
 * @interface WebchatStateInfo
 */
export interface WebchatStateInfo {
    /**
     * An ISO formatted timestamp
     * @type {string}
     * @memberof WebchatStateInfo
     */
...
export const ChatsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {boolean} [isNewGroup] Feature toggle for OR-group filter logic. When true, enables the new orGroups-based filtering where groups are OR\&#39;d together and filters within each group are AND\&#39;d. When false or omitted, uses the existing flat filter logic.
         * @param {string} [orGroups] JSON-encoded array of filter groups. Each group is an object with filter fields (tags, assignee, accountId, etc.). Groups are OR\&#39;d together; filters within each group are AND\&#39;d. Cannot be combined with top-level filter params (tags, assignee, etc.). Requires isNewGroup&#x3D;true.
         * @param {boolean} [returnUnreadChatCount] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        chatsGet: async (count?: number, page?: string, archive?: boolean, unread?: boolean, returnTotalCount?: boolean, hasPendingMessage?: boolean, mentioned?: string, hasUnsolvedNote?: boolean, hasFailedMessage?: boolean, lastMessageFromMe?: boolean, chatLastMessageFrom?: string, chatLastMessageTo?: string, tags?: ChatsGetTagsParameter, tagsFilterOperator?: ChatsGetTagsFilterOperatorEnum, notTags?: Array<string>, contacts?: ChatsGetContactsParameter, q?: string, assignee?: ChatsGetAssigneeParameter, assigneeFilterOperator?: ChatsGetAssigneeFilterOperatorEnum, accountId?: Array<string>, type?: ContactType, ticket?: ChatsGetTicketParameter, notAssignee?: Array<string>, isNewGroup?: boolean, orGroups?: string, returnUnreadChatCount?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            if (isNewGroup !== undefined) {
                localVarQueryParameter['isNewGroup'] = isNewGroup;
            }

            if (orGroups !== undefined) {
                localVarQueryParameter['orGroups'] = orGroups;
            }
...
export const ChatsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async chatsGet(count?: number, page?: string, archive?: boolean, unread?: boolean, returnTotalCount?: boolean, hasPendingMessage?: boolean, mentioned?: string, hasUnsolvedNote?: boolean, hasFailedMessage?: boolean, lastMessageFromMe?: boolean, chatLastMessageFrom?: string, chatLastMessageTo?: string, tags?: ChatsGetTagsParameter, tagsFilterOperator?: ChatsGetTagsFilterOperatorEnum, notTags?: Array<string>, contacts?: ChatsGetContactsParameter, q?: string, assignee?: ChatsGetAssigneeParameter, assigneeFilterOperator?: ChatsGetAssigneeFilterOperatorEnum, accountId?: Array<string>, type?: ContactType, ticket?: ChatsGetTicketParameter, notAssignee?: Array<string>, isNewGroup?: boolean, orGroups?: string, returnUnreadChatCount?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ChatsGet200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.chatsGet(count, page, archive, unread, returnTotalCount, hasPendingMessage, mentioned, hasUnsolvedNote, hasFailedMessage, lastMessageFromMe, chatLastMessageFrom, chatLastMessageTo, tags, tagsFilterOperator, notTags, contacts, q, assignee, assigneeFilterOperator, accountId, type, ticket, notAssignee, isNewGroup, orGroups, returnUnreadChatCount, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ChatsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        chatsGet(requestParameters: ChatsApiChatsGetRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<ChatsGet200Response> {
            return localVarFp.chatsGet(requestParameters.count, requestParameters.page, requestParameters.archive, requestParameters.unread, requestParameters.returnTotalCount, requestParameters.hasPendingMessage, requestParameters.mentioned, requestParameters.hasUnsolvedNote, requestParameters.hasFailedMessage, requestParameters.lastMessageFromMe, requestParameters.chatLastMessageFrom, requestParameters.chatLastMessageTo, requestParameters.tags, requestParameters.tagsFilterOperator, requestParameters.notTags, requestParameters.contacts, requestParameters.q, requestParameters.assignee, requestParameters.assigneeFilterOperator, requestParameters.accountId, requestParameters.type, requestParameters.ticket, requestParameters.notAssignee, requestParameters.isNewGroup, requestParameters.orGroups, requestParameters.returnUnreadChatCount, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Update a chat -- read, unread, archive, pin etc.
...
export interface ChatsApiChatsGetRequest {
    ...
    /**
     * Feature toggle for OR-group filter logic. When true, enables the new orGroups-based filtering where groups are OR\&#39;d together and filters within each group are AND\&#39;d. When false or omitted, uses the existing flat filter logic.
     * @type {boolean}
     * @memberof ChatsApiChatsGet
     */
    ...
    /**
     * JSON-encoded array of filter groups. Each group is an object with filter fields (tags, assignee, accountId, etc.). Groups are OR\&#39;d together; filters within each group are AND\&#39;d. Cannot be combined with top-level filter params (tags, assignee, etc.). Requires isNewGroup&#x3D;true.
     * @type {string}
     * @memberof ChatsApiChatsGet
     */
...
export const ContactsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        contactsGet: async (tags?: ChatsGetTagsParameter, tagsFilterOperator?: ContactsGetTagsFilterOperatorEnum, notTags?: Array<string>, contacts?: ChatsGetContactsParameter, notContacts?: ChatsGetContactsParameter, minMessagesSent?: number, minMessagesRecv?: number, maxMessagesSent?: number, maxMessagesRecv?: number, q?: string, assignee?: ChatsGetAssigneeParameter, assigneeFilterOperator?: ContactsGetAssigneeFilterOperatorEnum, notAssignee?: Array<string>, accountId?: Array<string>, type?: ContactType, chatLastMessageFrom?: string, chatLastMessageTo?: string, lastMessageFromMe?: boolean, unread?: boolean, ticket?: ChatsGetTicketParameter, isNewGroup?: boolean, orGroups?: string, orderByTicketOrder?: boolean, returnTotalCount?: boolean, returnLastMessage?: boolean, page?: string, count?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/contacts`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        contactsPatch: async (tags?: ChatsGetTagsParameter, tagsFilterOperator?: ContactsPatchTagsFilterOperatorEnum, notTags?: Array<string>, contacts?: ChatsGetContactsParameter, notContacts?: ChatsGetContactsParameter, minMessagesSent?: number, minMessagesRecv?: number, maxMessagesSent?: number, maxMessagesRecv?: number, q?: string, assignee?: ChatsGetAssigneeParameter, assigneeFilterOperator?: ContactsPatchAssigneeFilterOperatorEnum, notAssignee?: Array<string>, accountId?: Array<string>, type?: ContactType, chatLastMessageFrom?: string, chatLastMessageTo?: string, lastMessageFromMe?: boolean, unread?: boolean, ticket?: ChatsGetTicketParameter, isNewGroup?: boolean, orGroups?: string, contactsPatch?: ContactsPatch, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/contacts`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ContactsApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async contactsGet(tags?: ChatsGetTagsParameter, tagsFilterOperator?: ContactsGetTagsFilterOperatorEnum, notTags?: Array<string>, contacts?: ChatsGetContactsParameter, notContacts?: ChatsGetContactsParameter, minMessagesSent?: number, minMessagesRecv?: number, maxMessagesSent?: number, maxMessagesRecv?: number, q?: string, assignee?: ChatsGetAssigneeParameter, assigneeFilterOperator?: ContactsGetAssigneeFilterOperatorEnum, notAssignee?: Array<string>, accountId?: Array<string>, type?: ContactType, chatLastMessageFrom?: string, chatLastMessageTo?: string, lastMessageFromMe?: boolean, unread?: boolean, ticket?: ChatsGetTicketParameter, isNewGroup?: boolean, orGroups?: string, orderByTicketOrder?: boolean, returnTotalCount?: boolean, returnLastMessage?: boolean, page?: string, count?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContactsGet200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.contactsGet(tags, tagsFilterOperator, notTags, contacts, notContacts, minMessagesSent, minMessagesRecv, maxMessagesSent, maxMessagesRecv, q, assignee, assigneeFilterOperator, notAssignee, accountId, type, chatLastMessageFrom, chatLastMessageTo, lastMessageFromMe, unread, ticket, isNewGroup, orGroups, orderByTicketOrder, returnTotalCount, returnLastMessage, page, count, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
        ...
        async contactsPatch(tags?: ChatsGetTagsParameter, tagsFilterOperator?: ContactsPatchTagsFilterOperatorEnum, notTags?: Array<string>, contacts?: ChatsGetContactsParameter, notContacts?: ChatsGetContactsParameter, minMessagesSent?: number, minMessagesRecv?: number, maxMessagesSent?: number, maxMessagesRecv?: number, q?: string, assignee?: ChatsGetAssigneeParameter, assigneeFilterOperator?: ContactsPatchAssigneeFilterOperatorEnum, notAssignee?: Array<string>, accountId?: Array<string>, type?: ContactType, chatLastMessageFrom?: string, chatLastMessageTo?: string, lastMessageFromMe?: boolean, unread?: boolean, ticket?: ChatsGetTicketParameter, isNewGroup?: boolean, orGroups?: string, contactsPatch?: ContactsPatch, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContactsPatch200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.contactsPatch(tags, tagsFilterOperator, notTags, contacts, notContacts, minMessagesSent, minMessagesRecv, maxMessagesSent, maxMessagesRecv, q, assignee, assigneeFilterOperator, notAssignee, accountId, type, chatLastMessageFrom, chatLastMessageTo, lastMessageFromMe, unread, ticket, isNewGroup, orGroups, contactsPatch, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export class ContactsApi extends BaseAPI {
    ...
    public contactsPatch(requestParameters: ContactsApiContactsPatchRequest = {}, options?: RawAxiosRequestConfig) {
        return ContactsApiFp(this.configuration).contactsPatch(requestParameters.tags, requestParameters.tagsFilterOperator, requestParameters.notTags, requestParameters.contacts, requestParameters.notContacts, requestParameters.minMessagesSent, requestParameters.minMessagesRecv, requestParameters.maxMessagesSent, requestParameters.maxMessagesRecv, requestParameters.q, requestParameters.assignee, requestParameters.assigneeFilterOperator, requestParameters.notAssignee, requestParameters.accountId, requestParameters.type, requestParameters.chatLastMessageFrom, requestParameters.chatLastMessageTo, requestParameters.lastMessageFromMe, requestParameters.unread, requestParameters.ticket, requestParameters.isNewGroup, requestParameters.orGroups, requestParameters.contactsPatch, options).then((request) => request(this.axios, this.basePath));
    }
...
/**
 * WABAApi - axios parameter creator
 * @export
 */
export const WABAApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} accountId 
         * @param {WabaCallPostRequest} wabaCallPostRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        wabaCallPost: async (accountId: string, wabaCallPostRequest: WabaCallPostRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
            assertParamExists('wabaCallPost', 'accountId', accountId)
            // verify required parameter 'wabaCallPostRequest' is not null or undefined
            assertParamExists('wabaCallPost', 'wabaCallPostRequest', wabaCallPostRequest)
            const localVarPath = `/waba/call/{accountId}`
                .replace(`{${"accountId"}}`, encodeURIComponent(String(accountId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(wabaCallPostRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        wabaEnableCallingPost: async (accountId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
            assertParamExists('wabaEnableCallingPost', 'accountId', accountId)
            const localVarPath = `/waba/enable-calling/{accountId}`
                .replace(`{${"accountId"}}`, encodeURIComponent(String(accountId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        /**
         * Atomically claims the call for this agent and sends the WebRTC SDP answer to Meta. Returns 409 if another agent already answered.
         * @summary Claim and answer an incoming WhatsApp call
         * @param {string} accountId 
         * @param {string} callId 
         * @param {WabaIncomingCallClaimPostRequest} wabaIncomingCallClaimPostRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        wabaIncomingCallClaimPost: async (accountId: string, callId: string, wabaIncomingCallClaimPostRequest: WabaIncomingCallClaimPostRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
            assertParamExists('wabaIncomingCallClaimPost', 'accountId', accountId)
            // verify required parameter 'callId' is not null or undefined
            assertParamExists('wabaIncomingCallClaimPost', 'callId', callId)
            // verify required parameter 'wabaIncomingCallClaimPostRequest' is not null or undefined
            assertParamExists('wabaIncomingCallClaimPost', 'wabaIncomingCallClaimPostRequest', wabaIncomingCallClaimPostRequest)
            const localVarPath = `/waba/incoming-call/{accountId}/{callId}/claim`
                .replace(`{${"accountId"}}`, encodeURIComponent(String(accountId)))
                .replace(`{${"callId"}}`, encodeURIComponent(String(callId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(wabaIncomingCallClaimPostRequest, localVarRequestOptions, configuration)
        ...
        /**
         * Returns the first unclaimed incoming call for this WABA account, or null if none. Agents should poll this every few seconds.
         * @summary Poll for a pending incoming WhatsApp call
         * @param {string} accountId 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        wabaIncomingCallGet: async (accountId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
            assertParamExists('wabaIncomingCallGet', 'accountId', accountId)
            const localVarPath = `/waba/incoming-call/{accountId}`
                .replace(`{${"accountId"}}`, encodeURIComponent(String(accountId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
/**
 * WABAApi - functional programming interface
 * @export
 */
export const WABAApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async wabaCallPost(accountId: string, wabaCallPostRequest: WabaCallPostRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WabaCallPost200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.wabaCallPost(accountId, wabaCallPostRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WABAApi.wabaCallPost']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Returns the WebRTC SDP answer Meta sends back via webhook after a call is initiated. Returns 404 until the answer arrives — frontend should poll until it gets a 200.
         ...
         * @throws {RequiredError}
         */
        async wabaEnableCallingPost(accountId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AccountsDelete200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.wabaEnableCallingPost(accountId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WABAApi.wabaEnableCallingPost']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Atomically claims the call for this agent and sends the WebRTC SDP answer to Meta. Returns 409 if another agent already answered.
         ...
         * @throws {RequiredError}
         */
        async wabaIncomingCallGet(accountId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WabaIncomingCallGet200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.wabaIncomingCallGet(accountId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const WABAApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Enables the calling feature on the WABA phone number via Meta\'s settings API. Must be called once before business-initiated calls can be placed.
         * @summary Enable WhatsApp calling on a WABA phone number
         * @param {WABAApiWabaEnableCallingPostRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        wabaEnableCallingPost(requestParameters: WABAApiWabaEnableCallingPostRequest, options?: RawAxiosRequestConfig): AxiosPromise<AccountsDelete200Response> {
            return localVarFp.wabaEnableCallingPost(requestParameters.accountId, options).then((request) => request(axios, basePath));
        },
        /**
         * Atomically claims the call for this agent and sends the WebRTC SDP answer to Meta. Returns 409 if another agent already answered.
         * @summary Claim and answer an incoming WhatsApp call
         * @param {WABAApiWabaIncomingCallClaimPostRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
         ...
         * Returns the first unclaimed incoming call for this WABA account, or null if none. Agents should poll this every few seconds.
         * @summary Poll for a pending incoming WhatsApp call
         * @param {WABAApiWabaIncomingCallGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
 ...
 * @export
 * @interface WABAApiWabaCallPostRequest
 */
export interface WABAApiWabaCallPostRequest {
    /**
     * 
     * @type {string}
     * @memberof WABAApiWabaCallPost
     */
    readonly accountId: string

    /**
     * 
     * @type {WabaCallPostRequest}
     * @memberof WABAApiWabaCallPost
     */
    readonly wabaCallPostRequest: WabaCallPostRequest
}
 ...
 */
export interface WABAApiWabaEnableCallingPostRequest {
    /**
     * 
     * @type {string}
     * @memberof WABAApiWabaEnableCallingPost
     */
    readonly accountId: string
}

/**
 * Request parameters for wabaIncomingCallClaimPost operation in WABAApi.
 * @export
 * @interface WABAApiWabaIncomingCallClaimPostRequest
 */
export interface WABAApiWabaIncomingCallClaimPostRequest {
    /**
     * 
     * @type {string}
     * @memberof WABAApiWabaIncomingCallClaimPost
     */
    readonly accountId: string
    ...
    /**
     * 
     * @type {WabaIncomingCallClaimPostRequest}
     * @memberof WABAApiWabaIncomingCallClaimPost
     */
    readonly wabaIncomingCallClaimPostRequest: WabaIncomingCallClaimPostRequest
}

/**
 * Request parameters for wabaIncomingCallGet operation in WABAApi.
 * @export
 * @interface WABAApiWabaIncomingCallGetRequest
 */
export interface WABAApiWabaIncomingCallGetRequest {
    /**
     * 
     * @type {string}
     * @memberof WABAApiWabaIncomingCallGet
     */
    readonly accountId: string
}
...
export class WABAApi extends BaseAPI {
     ...
     * @memberof WABAApi
     */
    public wabaEnableCallingPost(requestParameters: WABAApiWabaEnableCallingPostRequest, options?: RawAxiosRequestConfig) {
        return WABAApiFp(this.configuration).wabaEnableCallingPost(requestParameters.accountId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WABAApi
     */
    public wabaIncomingCallClaimPost(requestParameters: WABAApiWabaIncomingCallClaimPostRequest, options?: RawAxiosRequestConfig) {
        return WABAApiFp(this.configuration).wabaIncomingCallClaimPost(requestParameters.accountId, requestParameters.callId, requestParameters.wabaIncomingCallClaimPostRequest, options).then((request) => request(this.axios, this.basePath));
    }
...
export const WABAHealthApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @summary Mark a WABA account as disconnected
         * @param {WabaDisconnectPostRequest} wabaDisconnectPostRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        wabaDisconnectPost: async (wabaDisconnectPostRequest: WabaDisconnectPostRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'wabaDisconnectPostRequest' is not null or undefined
            assertParamExists('wabaDisconnectPost', 'wabaDisconnectPostRequest', wabaDisconnectPostRequest)
            const localVarPath = `/waba-disconnect`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(wabaDisconnectPostRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        wabaStatusCheckPost: async (wabaStatusCheckPostRequest: WabaStatusCheckPostRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'wabaStatusCheckPostRequest' is not null or undefined
            assertParamExists('wabaStatusCheckPost', 'wabaStatusCheckPostRequest', wabaStatusCheckPostRequest)
            const localVarPath = `/waba-status-check`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(wabaStatusCheckPostRequest, localVarRequestOptions, configuration)
...
export const WABAHealthApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async wabaDisconnectPost(wabaDisconnectPostRequest: WabaDisconnectPostRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WabaDisconnectPost200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.wabaDisconnectPost(wabaDisconnectPostRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WABAHealthApi.wabaDisconnectPost']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Reads Meta\'s health_status field for the account\'s phone number (GET /{phoneNumberId}?fields=health_status). Returns a per-layer verdict (AVAILABLE / LIMITED / BLOCKED) for both the phone number and the owning business account, plus any blockers Meta reports (e.g. payment, account locked, unverified business).
         ...
         * @throws {RequiredError}
         */
        async wabaStatusCheckPost(wabaStatusCheckPostRequest: WabaStatusCheckPostRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WabaStatusCheckPost200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.wabaStatusCheckPost(wabaStatusCheckPostRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WABAHealthApi.wabaStatusCheckPost']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const WABAHealthApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * 
         * @summary Mark a WABA account as disconnected
         * @param {WABAHealthApiWabaDisconnectPostRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        wabaDisconnectPost(requestParameters: WABAHealthApiWabaDisconnectPostRequest, options?: RawAxiosRequestConfig): AxiosPromise<WabaDisconnectPost200Response> {
         ...
         * @throws {RequiredError}
         */
        wabaStatusCheckPost(requestParameters: WABAHealthApiWabaStatusCheckPostRequest, options?: RawAxiosRequestConfig): AxiosPromise<WabaStatusCheckPost200Response> {
            return localVarFp.wabaStatusCheckPost(requestParameters.wabaStatusCheckPostRequest, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for wabaDisconnectPost operation in WABAHealthApi.
 * @export
 * @interface WABAHealthApiWabaDisconnectPostRequest
 */
export interface WABAHealthApiWabaDisconnectPostRequest {
    /**
     * 
     * @type {WabaDisconnectPostRequest}
...
/**
 * Request parameters for wabaStatusCheckPost operation in WABAHealthApi.
 * @export
 * @interface WABAHealthApiWabaStatusCheckPostRequest
 */
export interface WABAHealthApiWabaStatusCheckPostRequest {
    /**
     * 
     * @type {WabaStatusCheckPostRequest}
     * @memberof WABAHealthApiWabaStatusCheckPost
     */
    readonly wabaStatusCheckPostRequest: WabaStatusCheckPostRequest
}
...
export class WABAHealthApi extends BaseAPI {
     ...
     * @memberof WABAHealthApi
     */
    public wabaStatusCheckPost(requestParameters: WABAHealthApiWabaStatusCheckPostRequest, options?: RawAxiosRequestConfig) {
        return WABAHealthApiFp(this.configuration).wabaStatusCheckPost(requestParameters.wabaStatusCheckPostRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
/**
 * WebChatApi - axios parameter creator
 * @export
 */
export const WebChatApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * New visitor messages, read receipts for team messages and the visitor details form, in one request. Every item is scoped to the conversation in the session token and goes through the same messaging pipeline as a WhatsApp webhook. Public route, authenticated by `sessionToken`.
         * @summary Receive events from a Web Chat visitor
         * @param {WebChatEvents} webChatEvents 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        webchatEventsPost: async (webChatEvents: WebChatEvents, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'webChatEvents' is not null or undefined
            assertParamExists('webchatEventsPost', 'webChatEvents', webChatEvents)
            const localVarPath = `/webchat/events`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(webChatEvents, localVarRequestOptions, configuration)
        ...
        /**
         * History when the widget reopens, and the polling fallback when the event stream is unavailable. Hard-scoped to the conversation in the session token. Public route, authenticated by `sessionToken`.
         * @summary Fetch the visitor\'s conversation
         * @param {string} sessionToken 
         * @param {string} [after] Only return messages newer than this timestamp
         * @param {number} [count] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        webchatMessagesGet: async (sessionToken: string, after?: string, count?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'sessionToken' is not null or undefined
            assertParamExists('webchatMessagesGet', 'sessionToken', sessionToken)
            const localVarPath = `/webchat/messages`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        /**
         * Generates a new public widget key and signing secret and bumps the key version. Every live visitor session token stops working and the customer must re-paste the snippet.
         * @summary Rotate the Web Chat widget key
         * @param {string} accountId 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        webchatRotateKeyPost: async (accountId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
            assertParamExists('webchatRotateKeyPost', 'accountId', accountId)
            const localVarPath = `/accounts/{accountId}/webchat/rotate-key`
                .replace(`{${"accountId"}}`, encodeURIComponent(String(accountId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        /**
         * Called by the Web Chat widget when it loads on the customer\'s website. Validates the public widget key, checks the page origin against the channel\'s allowed domains, mints or resumes the visitor id and returns a signed session token plus the public widget configuration. Public route: the widget key is the credential.
         * @summary Start or resume a Web Chat visitor session
         * @param {WebchatSessionPostRequest} webchatSessionPostRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        webchatSessionPost: async (webchatSessionPostRequest: WebchatSessionPostRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'webchatSessionPostRequest' is not null or undefined
            assertParamExists('webchatSessionPost', 'webchatSessionPostRequest', webchatSessionPostRequest)
            const localVarPath = `/webchat/session`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(webchatSessionPostRequest, localVarRequestOptions, configuration)
        ...
        /**
         * Long-lived `text/event-stream` carrying team replies, typing and read events for one conversation. EventSource cannot set headers, so the session token is a query parameter. The widget falls back to polling `webchatMessagesGet` when the stream cannot be opened.
         * @summary Server-sent events for the visitor
         * @param {string} sessionToken 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        webchatStreamGet: async (sessionToken: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'sessionToken' is not null or undefined
            assertParamExists('webchatStreamGet', 'sessionToken', sessionToken)
            const localVarPath = `/webchat/stream`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
/**
 * WebChatApi - functional programming interface
 * @export
 */
export const WebChatApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = WebChatApiAxiosParamCreator(configuration)
    return {
        /**
         * New visitor messages, read receipts for team messages and the visitor details form, in one request. Every item is scoped to the conversation in the session token and goes through the same messaging pipeline as a WhatsApp webhook. Public route, authenticated by `sessionToken`.
         * @summary Receive events from a Web Chat visitor
         ...
         * @throws {RequiredError}
         */
        async webchatEventsPost(webChatEvents: WebChatEvents, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebchatEventsPost200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.webchatEventsPost(webChatEvents, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WebChatApi.webchatEventsPost']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * History when the widget reopens, and the polling fallback when the event stream is unavailable. Hard-scoped to the conversation in the session token. Public route, authenticated by `sessionToken`.
         ...
         * @throws {RequiredError}
         */
        async webchatMessagesGet(sessionToken: string, after?: string, count?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebchatMessagesGet200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.webchatMessagesGet(sessionToken, after, count, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WebChatApi.webchatMessagesGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Generates a new public widget key and signing secret and bumps the key version. Every live visitor session token stops working and the customer must re-paste the snippet.
         ...
         * @throws {RequiredError}
         */
        async webchatRotateKeyPost(accountId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebchatRotateKeyPost200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.webchatRotateKeyPost(accountId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WebChatApi.webchatRotateKeyPost']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Called by the Web Chat widget when it loads on the customer\'s website. Validates the public widget key, checks the page origin against the channel\'s allowed domains, mints or resumes the visitor id and returns a signed session token plus the public widget configuration. Public route: the widget key is the credential.
         ...
         * @throws {RequiredError}
         */
        async webchatSessionPost(webchatSessionPostRequest: WebchatSessionPostRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebChatSession>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.webchatSessionPost(webchatSessionPostRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WebChatApi.webchatSessionPost']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Long-lived `text/event-stream` carrying team replies, typing and read events for one conversation. EventSource cannot set headers, so the session token is a query parameter. The widget falls back to polling `webchatMessagesGet` when the stream cannot be opened.
         ...
         * @throws {RequiredError}
         */
        async webchatStreamGet(sessionToken: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.webchatStreamGet(sessionToken, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WebChatApi.webchatStreamGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * WebChatApi - factory interface
 * @export
 */
export const WebChatApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = WebChatApiFp(configuration)
    return {
        /**
         * New visitor messages, read receipts for team messages and the visitor details form, in one request. Every item is scoped to the conversation in the session token and goes through the same messaging pipeline as a WhatsApp webhook. Public route, authenticated by `sessionToken`.
         * @summary Receive events from a Web Chat visitor
         * @param {WebChatApiWebchatEventsPostRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        webchatEventsPost(requestParameters: WebChatApiWebchatEventsPostRequest, options?: RawAxiosRequestConfig): AxiosPromise<WebchatEventsPost200Response> {
            return localVarFp.webchatEventsPost(requestParameters.webChatEvents, options).then((request) => request(axios, basePath));
        },
        /**
         * History when the widget reopens, and the polling fallback when the event stream is unavailable. Hard-scoped to the conversation in the session token. Public route, authenticated by `sessionToken`.
         * @summary Fetch the visitor\'s conversation
         * @param {WebChatApiWebchatMessagesGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        webchatMessagesGet(requestParameters: WebChatApiWebchatMessagesGetRequest, options?: RawAxiosRequestConfig): AxiosPromise<WebchatMessagesGet200Response> {
            return localVarFp.webchatMessagesGet(requestParameters.sessionToken, requestParameters.after, requestParameters.count, options).then((request) => request(axios, basePath));
        },
        /**
         * Generates a new public widget key and signing secret and bumps the key version. Every live visitor session token stops working and the customer must re-paste the snippet.
         * @summary Rotate the Web Chat widget key
         * @param {WebChatApiWebchatRotateKeyPostRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        webchatRotateKeyPost(requestParameters: WebChatApiWebchatRotateKeyPostRequest, options?: RawAxiosRequestConfig): AxiosPromise<WebchatRotateKeyPost200Response> {
            return localVarFp.webchatRotateKeyPost(requestParameters.accountId, options).then((request) => request(axios, basePath));
        },
        /**
         * Called by the Web Chat widget when it loads on the customer\'s website. Validates the public widget key, checks the page origin against the channel\'s allowed domains, mints or resumes the visitor id and returns a signed session token plus the public widget configuration. Public route: the widget key is the credential.
         * @summary Start or resume a Web Chat visitor session
         * @param {WebChatApiWebchatSessionPostRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        webchatSessionPost(requestParameters: WebChatApiWebchatSessionPostRequest, options?: RawAxiosRequestConfig): AxiosPromise<WebChatSession> {
            return localVarFp.webchatSessionPost(requestParameters.webchatSessionPostRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Long-lived `text/event-stream` carrying team replies, typing and read events for one conversation. EventSource cannot set headers, so the session token is a query parameter. The widget falls back to polling `webchatMessagesGet` when the stream cannot be opened.
         * @summary Server-sent events for the visitor
         * @param {WebChatApiWebchatStreamGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        webchatStreamGet(requestParameters: WebChatApiWebchatStreamGetRequest, options?: RawAxiosRequestConfig): AxiosPromise<string> {
            return localVarFp.webchatStreamGet(requestParameters.sessionToken, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for webchatEventsPost operation in WebChatApi.
 * @export
 * @interface WebChatApiWebchatEventsPostRequest
 */
export interface WebChatApiWebchatEventsPostRequest {
    /**
     * 
     * @type {WebChatEvents}
     * @memberof WebChatApiWebchatEventsPost
     */
    readonly webChatEvents: WebChatEvents
}

/**
 * Request parameters for webchatMessagesGet operation in WebChatApi.
 * @export
 * @interface WebChatApiWebchatMessagesGetRequest
 */
export interface WebChatApiWebchatMessagesGetRequest {
    /**
     * 
     * @type {string}
     * @memberof WebChatApiWebchatMessagesGet
     */
...
/**
 * Request parameters for webchatRotateKeyPost operation in WebChatApi.
 * @export
 * @interface WebChatApiWebchatRotateKeyPostRequest
 */
export interface WebChatApiWebchatRotateKeyPostRequest {
    /**
     * 
     * @type {string}
     * @memberof WebChatApiWebchatRotateKeyPost
     */
    readonly accountId: string
}

/**
 * Request parameters for webchatSessionPost operation in WebChatApi.
 * @export
 * @interface WebChatApiWebchatSessionPostRequest
 */
export interface WebChatApiWebchatSessionPostRequest {
    /**
     * 
     * @type {WebchatSessionPostRequest}
     * @memberof WebChatApiWebchatSessionPost
     */
    readonly webchatSessionPostRequest: WebchatSessionPostRequest
}

/**
 * Request parameters for webchatStreamGet operation in WebChatApi.
 * @export
 * @interface WebChatApiWebchatStreamGetRequest
 */
export interface WebChatApiWebchatStreamGetRequest {
    /**
     * 
     * @type {string}
     * @memberof WebChatApiWebchatStreamGet
     */
    readonly sessionToken: string
}

/**
 * WebChatApi - object-oriented interface
 * @export
 * @class WebChatApi
 * @extends {BaseAPI}
 */
export class WebChatApi extends BaseAPI {
    /**
     * New visitor messages, read receipts for team messages and the visitor details form, in one request. Every item is scoped to the conversation in the session token and goes through the same messaging pipeline as a WhatsApp webhook. Public route, authenticated by `sessionToken`.
     * @summary Receive events from a Web Chat visitor
     * @param {WebChatApiWebchatEventsPostRequest} requestParameters Request parameters.
     ...
     * @memberof WebChatApi
     */
    public webchatEventsPost(requestParameters: WebChatApiWebchatEventsPostRequest, options?: RawAxiosRequestConfig) {
        return WebChatApiFp(this.configuration).webchatEventsPost(requestParameters.webChatEvents, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WebChatApi
     */
    public webchatMessagesGet(requestParameters: WebChatApiWebchatMessagesGetRequest, options?: RawAxiosRequestConfig) {
        return WebChatApiFp(this.configuration).webchatMessagesGet(requestParameters.sessionToken, requestParameters.after, requestParameters.count, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WebChatApi
     */
    public webchatRotateKeyPost(requestParameters: WebChatApiWebchatRotateKeyPostRequest, options?: RawAxiosRequestConfig) {
        return WebChatApiFp(this.configuration).webchatRotateKeyPost(requestParameters.accountId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WebChatApi
     */
    public webchatSessionPost(requestParameters: WebChatApiWebchatSessionPostRequest, options?: RawAxiosRequestConfig) {
        return WebChatApiFp(this.configuration).webchatSessionPost(requestParameters.webchatSessionPostRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WebChatApi
     */
    public webchatStreamGet(requestParameters: WebChatApiWebchatStreamGetRequest, options?: RawAxiosRequestConfig) {
        return WebChatApiFp(this.configuration).webchatStreamGet(requestParameters.sessionToken, options).then((request) => request(this.axios, this.basePath));
    }
}
